...
Try {
	...
	[string]$appName = 'Windows Management Framework'
	[string]$appVersion = '5.1'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '01/24/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$envSystem32Directory\wusa.exe" -Parameters "`"${dirFiles}\Win7AndW2K8R2-KB3191566-x64.msu`" /quiet /norestart /log:`"${envWinDir}\Logs\Software\WMF_5.1-Install.log`"" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envSystem32Directory\wusa.exe" -Parameters "/uninstall ${dirFiles}\Win7AndW2K8R2-KB3191566-x64.msu /quiet /norestart /log:${envWinDir}\Logs\Software\WMF_5.1-Uninstall.log " -WindowStyle "Hidden" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUG3sakA1qn7v0
# UXmDx+Y6u19aXbjj5IOOMdqU07SThaCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIAbD
# KKXhoEcaGE5FbMuFFrUH1goV/OufIHvyL6z25Ce4MA0GCSqGSIb3DQEBAQUABIIB
# AJJ8gCrKkSnZOoaFSGAz7MAWQMuubkDYkWFIpuvuxXhDOzQaR/AyVUqd4GlJW3ll
# QRBCPlarsTwJ4u/EmlcXzMckngEKOzUYU3M6DvZdq1Q/mOBBTrntGIWOHndkxIu/
# NYEc8z1bGYOpmFw9jji+2V5B3trCtaETS31DurbWhWOhW+TrJesEudv8+ZlO/p0f
# dLZJ8ox+exjhLIQ47Aw++ag7Ap3TveiU8Udw+xZ3Cj54Cn89euidXL8z35QnuOUw
# sv4bUZ5jXpjxbB6wRWACGFUWvSIRbeJVwtJJakb92HL8mQknr6m5n7HIVCaZyx8E
# 5OiG/tFjsDt690mu5YVsKeKhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMTI0MjE1MjEyWjAjBgkqhkiG9w0BCQQxFgQU
# dtcaxGk1hi3zCm3d0qWFboIrjX0wgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAK6yCMjiv6vryIzqi+HXElc3WolhDjLU9vCiAFNAie6yynosMFT39Iod
# zEaUjaQkeynF70TiSQkufg4vJuRjLfpsLpktHBKmjeAoMSNZf/a5qTB0xQp23fDW
# uYqDXykxIvkcm7HbQlFHPHpxpA0gf0ushzDRlm0XUmtdzOZZgjcBSSRmR9WH4neQ
# Cx4pi/WPaS+pfShgSGb4yvXAePuY+7YO+ev+2cufTGlJoMbGvAOjec3yNo07PZAL
# hoEIC6Se+KJE03kuiu7aUAwG/vJAylqXndEs/aOjbF4Rgao3ZYc8DNnwyd8Af7P3
# 7SsNgsTVbPnZBBH8XrkxbWQaNHtq2V4=
